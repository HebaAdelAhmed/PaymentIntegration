class PaymentRefCodeKiosk {
  ...
  factory PaymentRefCodeKiosk.fromJson(Map<String, dynamic> json) => PaymentRefCodeKiosk(
    id: json["id"],
    ...
    data: PaymentRefCodeKioskData.fromJson(json["data"]),
...
class PaymentRefCodeKioskData {
  ...
  factory PaymentRefCodeKioskData.fromJson(Map<String, dynamic> json) => PaymentRefCodeKioskData(
    klass: json["klass"],
